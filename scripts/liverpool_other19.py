...
def calcDataGFMinusXG(team_name, season):
  return accumulative_pl.getTeamDataAvg(team_name, season, 'gf') - accumulative_pl.getTeamDataAvg(team_name, season, 'xg')
...
ax2.set_ylabel('Liverpool points gained', color="brown")
